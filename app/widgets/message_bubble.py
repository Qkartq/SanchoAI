import flet as ft
from flet import Container, Column, Text, Row, ProgressRing
...
class MessageBubble(Container):
    def __init__(self, role: str, content: str, **kwargs):
        ...
        bubble_color = ft.Colors.BLUE_100 if is_user else ft.Colors.SURFACE_CONTAINER_HIGH
        text_color = ft.Colors.ON_SURFACE if is_user else ft.Colors.ON_SURFACE_VARIANT
    ...
    def __init__(self, text: str = "Thinking..."):
        super().__init__(
            content=Row([
                ...
                Text(text, size=14, color=ft.Colors.ON_SURFACE),
                AnimatedDots(),
            ], spacing=8),
...
class AnimatedDots(Row):
    def __init__(self):
        ...
        self.dot1 = ft.Text("•", size=20, color=ft.Colors.PRIMARY)
        self.dot2 = ft.Text("•", size=20, color=ft.Colors.PRIMARY)
        self.dot3 = ft.Text("•", size=20, color=ft.Colors.PRIMARY)
